...
function getcon(Id) {
    $.ajax({
        type: "GET",
        url: "/Quanlywebsite/CategoryNewsAdmin/Loadmenu_Lever_muti",
        data: { Id: Id },
        dataType: "json",
...
function getcon_leve2(Id) {
    $.ajax({
        type: "GET",
        url: "/Quanlywebsite/CategoryNewsAdmin/Loadmenu_Lever2_muti_Id",
        data: { Id: Id },
        dataType: "json",
        success: function (data) {
            if (data.Level != "") {
...
function getcon_leve1(Id) {
    $.ajax({
        type: "GET",
        url: "/Quanlywebsite/CategoryNewsAdmin/Loadmenu_Lever1_muti_",
        data: { Id: Id },
        dataType: "json",
        success: function (data) {
            if (data.Level != "") {
