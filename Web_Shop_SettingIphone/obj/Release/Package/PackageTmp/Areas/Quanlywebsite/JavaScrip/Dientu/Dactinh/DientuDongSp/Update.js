function Upadte() {
    ...
    var object = { //khai báo các giá trị xóa trống
        Id: $("#TxtId").val(),
        Idnsx: $('#SelectThuonghieuDt>option:selected').val(),
        Name: $("#TxtName").val(),
        Active: "",
        Ord: $("#TxtOrd").val(),
    };
    ...
    if (object.Idnsx == null || object.Idnsx == "") {
        var html = "<span  class='error'>Chưa chọn danh mục</span>";
        $("#SelectThuonghieuDt").parent().append(html);
        flag = false;
    }
    ...
    if (flag == true) { //trạng thái đúng bắt đầu xử lý
        ...
        setTimeout(function () {
            ...
            $.ajax({
                url: "/Quanlywebsite/DientuDongSpAdmin/Update",
                type: "Post",
                data: object,
                datatype: "json",
                    ...
                    if (data == 1 || data == 0) {
                        if (data == 1) {
                            ...
                            window.setTimeout(function () {
                                ...
                                location.href = "/Quanlywebsite/DientuDongSpAdmin/Read";
                            }, 2000)
