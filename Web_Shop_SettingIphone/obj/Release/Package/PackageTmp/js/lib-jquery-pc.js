...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    function i(i) {
        i && 3 === i.which || (t(n).remove(), t(s).each(function() {
            ...
            n.hasClass("open") && (i && "click" == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(n[0], i.target) || (n.trigger(i = t.Event("hide.bs.dropdown", s)), i.isDefaultPrevented() 
...
function locdau(o) {
    return o = o.toLowerCase(), o = o.replace(/� |á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ặ|ẳ|ẵ/g, "a"), o = o.replace(/è|é|ẹ|ẻ|ẽ|ê|ề|ế|ệ|ể|ễ/g, "e"), o = o.replace(/ì|í|ị|ỉ|ĩ/g, "i"), o = o.replace(/ò|ó|ọ|ỏ|õ|ô|ồ|ố|ộ|ổ|ỗ|ơ|ờ|ớ|ợ|ở|ỡ/g, "o"), o = o.replace(/ù|ú|ụ|ủ|ũ|ư|ừ|ứ|ự|ử|ữ/g, "u"), o = o.replace(/ỳ|ý|ỵ|ỷ|ỹ/g, "y"), o = o.replace(/đ/g, "d")
}! function(o) {
    "use strict";
    ...
    function t() {
        o(window).scroll(function() {
            ...
            l.hasClass("js-opened") ? (l.slideUp("normal", "easeOutExpo").removeClass("js-opened"), s.removeClass("active")) : (l.slideDown("normal", "easeOutQuart").addClass("js-opened"), s.addClass("active"))
    ...
    var s = o(".mobile-nav"),
        l = o(".desktop-nav"),
        c = o(".main-nav"),
        r = o("#location-global").find(".dropdown-vta-tabs").children("div"),
        ...
        p = {
            ...
            container: o("#location-global").find(".dropdown-vta-content"),
            init: function() {
    ...
    var f = o("#location-global2").find(".dropdown-vta-tabs").children("div"),
        ...
        h = {
            ...
            container: o("#location-global2").find(".dropdown-vta-content"),
            init: function() {
