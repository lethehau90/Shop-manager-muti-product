...
{
    public class DientuLoaithuoctinhAdminController : Controller
    {
        //
        // GET: /Quanlywebsite/DientuLoaithuoctinhAdmin/

        private Web_Shop_SettingIphoneEntities connect_entity = new Web_Shop_SettingIphoneEntities();
        DientuLoaithuoctinh_Service Connect = new DientuLoaithuoctinh_Service();
        int Resurt;
        ...
        {
            var data = connect_entity.DientuLoaithuoctinhs.Find(Id);
        ...
        public JsonResult Get_Read(int Id)
        {
            try
            {
                var data = connect_entity.DientuLoaithuoctinhs.FirstOrDefault(x => x.Id == Id);
        ...
        {
            DientuLoaithuoctinh_Model data = new DientuLoaithuoctinh_Model();//gọi model data
            data.Name = Name;
            data.Active = Convert.ToBoolean(Active);
            data.Ord = Convert.ToInt32(Ord);
            data.Content = Content;

            if (connect_entity.DientuLoaithuoctinhs.FirstOrDefault
