        ...
        $.jAlert({
            'type': 'confirm', 'confirmQuestion': 'Bạn xác nhận xóa ?', 'onConfirm': function () {
                ...
                setTimeout(function () {
                    ...
                    $.ajax({
                        url: "/Quanlywebsite/CommentProductAdmin/Deleteone",
                        type: "Post",
                        data: { Id: Id },
                        datatype: "json",
                        success: function (data) {
                            if(data==1)
                            {
                                location.href = "/Quanlywebsite/CommentProductAdmin/Read";
                            }
                            else
                            {
                                alert_Role();
                ...
                if (id.length > 0) {
                        ...
                        setTimeout(function () {
                            ...
                            $.ajax({
                                ...
                                url: "/Quanlywebsite/CommentProductAdmin/DeleteAll",
            ...
            setTimeout(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == 1) {
                            location.href = "/Quanlywebsite/CommentProductAdmin/Read";
                            //$("#Edit'"+Id+"'").trigger("click", function () {
                            //    get_Read_Rep(ProId, Id);
                            //});
