        ...
        $.jAlert({
            'type': 'confirm', 'confirmQuestion': 'Bạn xác nhận xóa ?', 'onConfirm': function () {
                ...
                setTimeout(function () {
                    ...
                    $.ajax({
                        url: "/Quanlywebsite/CategotyproductdetailAdmin/Deleteone",
                        type: "Post",
                        data: { Id: Id },
                        datatype: "json",
                        success: function (data) {
                            if(data==1)
                            {
                                location.href = "/Quanlywebsite/CategotyproductdetailAdmin/Read";
                            }
                            else
                            {
                                alert_Role();
                ...
                if (id.length > 0) {
                        ...
                        setTimeout(function () {
                            $.ajax({
                                ...
                                url: "/Quanlywebsite/CategotyproductdetailAdmin/DeleteAll",
